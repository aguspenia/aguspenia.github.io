...
const WhatsAppButton: React.FC = () => {
  // Obtenemos el número del archivo de constantes
  const rawNumber = TEXTS.CONTACT.PHONE;
  
  // Limpiamos el número para la URL de WhatsApp:
  // 1. Quitamos todo lo que no sea número (\D)
  // 2. Quitamos el primer "0" de la característica (011 -> 11)
  // 3. Agregamos el código de país para Argentina (54) y el prefijo de móvil (9)
  ...
  return (
    ...
    >
      ...
      {/* Tooltip con estilo Lopez y Asociados */}
      <span className="absolute right-[80px] bg-[#0a192f] text-white text-[9px] font-bold uppercase tracking-[0.2em] px-4 py-2 rounded-sm opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap shadow-2xl pointer-events-none">
        ATENCIÓN INMEDIATA
      </span>
    </a>
  );
